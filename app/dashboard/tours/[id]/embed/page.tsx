...
import { ArrowLeft, Loader2, Copy, CheckCircle2, AlertTriangle, Code2, Terminal, PlayCircle, Settings } from 'lucide-react';
...
function App() {
  ...
  const cardStyle = "rounded-3xl border-2 border-white/50 bg-white/80 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300";
      ...
      <div className='container mx-auto px-4 py-12 max-w-5xl relative z-10'>        
        ...
        {!tour.is_active && (
          <Alert className='mb-8 rounded-2xl border-amber-200 bg-amber-50 text-amber-900 shadow-md'>
            ...
            <AlertTitle className="text-amber-800 font-bold ml-2">Tour Inactive</AlertTitle>
        ...
        <div className='space-y-6'>
            ...
            <CardHeader className="pb-2">
              <div className='flex flex-col md:flex-row md:items-start justify-between gap-4'>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <CardTitle className={headerTextStyle}>Embeddable Script</CardTitle>
            ...
            <CardHeader className="pb-2">
              <div className='flex flex-col md:flex-row md:items-start justify-between gap-4'>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <CardTitle className={headerTextStyle}>NPM Package</CardTitle>
                    <CardDescription className={subTextStyle}>
            ...
            <CardHeader className="pb-2">
              <div className='flex flex-col md:flex-row md:items-start justify-between gap-4'>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <CardTitle className={headerTextStyle}>React Integration</CardTitle>
                    <CardDescription className={subTextStyle}>
          ...
          <Card className={`${cardStyle} border-brand-teal/30`}>
            <CardHeader>
               <div className="flex items-center space-x-4 mb-2">
                  ...
                  <CardTitle className={headerTextStyle}>Configuration Options</CardTitle>
               </div>
              <CardDescription className={subTextStyle}>
            ...
            <CardContent>
              <div className='space-y-4'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  {[
                    { key: 'tourId', desc: 'Your unique tour identifier (required)' },
                    { key: 'secret_key', desc: 'Your user id (required)' },
                    { key: 'resume', desc: 'Adds resume button to the steps (default: true)' },
                    { key: 'styles', desc: 'Customizable widget styles object' },
                    { key: 'onEvent', desc: 'Callback function when tour completes' }
                  ].map((item, i) => (
                     <div key={i} className="p-4 rounded-2xl bg-white/50 border border-white/60 hover:border-brand-teal/40 transition-colors">
          ...
          <Card className='rounded-3xl border-0 bg-linear-to-r from-brand-sky via-blue-500 to-brand-teal text-white shadow-xl overflow-hidden relative'>
            ...
            <CardContent className='p-8 md:p-10 relative z-10 flex flex-col md:flex-row items-center justify-between gap-6'>
              ...
              <Link href='/docs'>
                <Button size='lg' className='bg-white text-blue-600 hover:bg-blue-50 border-0 rounded-full shadow-lg font-semibold px-8 h-12'>
                  Read Documentation
                </Button>
              </Link>
            </CardContent>
